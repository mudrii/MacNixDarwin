...
*/
  ...
  users = {
    ...
    users.mudrii = {
      ...
      openssh.authorizedKeys.keys = [ "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIUEYA2Yzduq5+pXF+vsGXqbHA2l2tOnmP1Ek3BgI7jp mudreac@gmail.com"];
      packages = with pkgs; [
        home-manager
        #unstable.bpytop
        unstable.glances
  ...
  nix = {
    ...
    settings = {
      sandbox = true;
      trusted-users = [ "@wheel" "mudrii" ];
      allowed-users = [ "@wheel" "mudrii" ];
